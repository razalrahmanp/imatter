...
// ── Helpers ───────────────────────────────────────────────────────────────────
function openTag(type, id, attrs = {}) {
...
function findTableSeparator(lines) {
...
function stripTrailingSeparator(lines) {
...
export function generateTaggedTemplate(sourceContent, version) {
...
export function serializeRegistry(registry, version) {
    const entries = [];
