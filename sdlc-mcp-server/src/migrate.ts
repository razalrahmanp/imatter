...
import { detectEdits, resolveEdits, applyResolutions, loadRegistryFile, type ResolutionAction } from "./resolve-edits.js";
...
function parseArgs(argv: string[]): Args {
  ...
  let autoResolve: ResolutionAction | undefined;
